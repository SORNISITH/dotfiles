...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cape command-log-mode corfu-terminal crux dirvish doom-themes
	  eglot-typescript-preset embark-consult emmet-mode
	  enh-ruby-mode gdb-x h5dump-mode javap-mode keycast
