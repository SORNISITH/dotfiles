...
SERVERS: list[list[str]] = [["/home/nzvoid/nz_work_space/js/vue_project/Portfolio_nz/node_modules/.bin/vue-language-server","--stdio"],["/home/nzvoid/.npm-global/bin/typescript-language-server","--stdio"],["tailwindcss-language-server","--stdio"]]  # type: ignore[name-defined]
INIT_OPTIONS: dict[str, Any] | None = {"typescript":{"tsdk":"/home/nzvoid/nz_work_space/js/vue_project/Portfolio_nz/node_modules/typescript/lib"},"vue":{"hybridMode":True}}  # type: ignore[name-defined]
ESLINT_LOGIC: bool = False  # type: ignore[name-defined]
VUE_TS_PLUGIN: str | None = "/home/nzvoid/nz_work_space/js/vue_project/Portfolio_nz/node_modules/@vue/typescript-plugin"  # type: ignore[name-defined]
